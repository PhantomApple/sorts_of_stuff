...
namespace kyrsovaia
{
    public partial class Childrens : Form
    {
        ...
        {
            string query = "SELECT c.FIO AS FIO_children, c.date_of_birth, c.Information, c.Entrance, p.FIO AS FIO_parent " +
                           "FROM Childrens c " +
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(Connect))
            {
                ...
                string insertChildQuery = "INSERT INTO Childrens ( FIO, date_of_birth, Information, Entrance, ID_parent) " + "VALUES ( @FIO, @dateOfBirth, @Information, @Entrance, @idParents)";
