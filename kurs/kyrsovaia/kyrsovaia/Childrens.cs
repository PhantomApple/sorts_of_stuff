...
namespace kyrsovaia
{
    public partial class Childrens : Form
    {
        ...
        public Childrens()
        {
            ...
            LoadChildrenData();
            FillComboBox3();
            dataGridView1.Columns["FIO_children"].HeaderText = "ФИО ребенка";
            dataGridView1.Columns["date_of_birth"].HeaderText = "Дата рождения";
            dataGridView1.Columns["Information"].HeaderText = "Информация";
            dataGridView1.Columns["Entrance"].HeaderText = "Дата поступления";
            dataGridView1.Columns["FIO_parent"].HeaderText = "ФИО родителя";
            dataGridView1.Columns["Group_Name"].HeaderText = "Название группы";
        }
        private void Childrens_Load(object sender, EventArgs e)
        {
            this.groupsTableAdapter.Fill(this.kindergartens1DataSet.Groups);
            this.childrensTableAdapter.Fill(this.kindergartens1DataSet.Childrens);
            LoadParentsData();
            LoadGroupsData();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                DialogResult result = MessageBox.Show("Вы уверены, что хотите удалить " + fio + "?", "Подтверждение удаления", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        private void FillComboBox3()
        {
            ...
            comboBox3.Items.Add("date_of_birth");
            comboBox3.Items.Add("Entrance");
        ...
        {
            if (comboBox3.SelectedItem.ToString() == "date_of_birth" || comboBox3.SelectedItem.ToString() == "Entrance")
            {
                string columnName = comboBox3.SelectedItem.ToString();
                DataView dataView = dataTable.DefaultView;
